...
CommunitySectionView.prototype.onInitDone = function()
{
	...
	//TODO:edit here
	this.communityListView1.addItem('Source/ContainerViews/CommunityTabView/CommunitySectionView/ListItems/ListItemView.lay', this.listData1);
	this.communityListView2.addItem('Source/ContainerViews/CommunityTabView/CommunitySectionView/ListItems/ListItemView.lay', this.listData2);
...
/*	console.log(this.owner.aevent.acomp)
	...
	this.owner.selectTabById("qaTab");
// 	var tab = this.tabview.getTabByInx(1);
// 	this.owner.setTabUrl('Source/ContainerViews/CommunityTabView/CommunitySectionView/QaSectionView/QaSectionView.lay');
// 	this.owner.selectTab("qaTab");
