...
afc.extendsClass(DDListView, AListView);
...
DDListView.prototype.createItems = function(url, dataArray, posItem, isPrepend)
{
	var newItems = AListView.prototype.createItems.call(this, url, dataArray, posItem, isPrepend);
