...
afc.loadScript('Framework/mdfc/layout/FileUploaderItem.js');
...
afc.extendsClass(FileUploader, AView);
...
FileUploader.prototype.createElement = function(context)
{
	...
	{
		var item = $('<div></div>')[0];
		afc.loadHtml(item, 'Framework/mdfc/layout/FileUploaderItem.html');
