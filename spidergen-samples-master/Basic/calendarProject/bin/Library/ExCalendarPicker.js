afc.loadScript("Framework/mdfc/component/ACalendarPicker.js");
...
내용 : 확장캘린더피커
*/
function ExCalendarPicker()
{
	ACalendarPicker.call(this);
}
afc.extendsClass(ExCalendarPicker, ACalendarPicker);
