...
WebQueryManager.prototype.notiProcess = async function(recvObj)
{
	//----------------------------------------------------
...
WebQueryManager.prototype.onConnected = function(success)
{
...
WebQueryManager.prototype.onClosed = function()
{
	AIndicator.hide();
...
WebQueryManager.prototype.sendMessage = function(message)
{
	this.netIo.sendData(JSON.stringify(message));
};

WebQueryManager.prototype.jsonProcess = function(message)
{
	var listener, i, qLen = this.queryListeners.length;
