...
afc.loadScript('Framework/mdfc/layout/ACalendarPickerItem.js');
afc.loadScript('Framework/mdfc/layout/ACalendarItem.js');
afc.loadScript('Framework/mdfc/layout/ACalendarMonthItem.js');

function ACalendarPicker()
{
	AView.call(this);
...
afc.extendsClass(ACalendarPicker, AView);
...
ACalendarPicker.prototype.createElement = function(context)
{
	...
	if(this.$ele.children().length==0) 
	{
		...
		afc.loadHtml(item, 'Framework/mdfc/layout/ACalendarPickerItem.html');
...
ACalendarPicker.prototype.updatePosition = function()
{
